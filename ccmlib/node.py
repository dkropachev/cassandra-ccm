...
class Node(object):
    ...
    def start(self,
        ...
        if isinstance(wait_other_notice, int) and not isinstance(wait_other_notice, bool):
        ...
        if isinstance(wait_for_binary_proto, int) and not isinstance(wait_for_binary_proto, bool):
